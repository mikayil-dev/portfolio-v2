...
- Expressions formed by delimiting a list of expressions in parentheses are called ***combinations***.
- The first element is called the ***operator***, the elements following are called ***operands***.
